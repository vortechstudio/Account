            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        <!--begin::Toolbar-->
                        <div id="kt_app_toolbar" class="app-toolbar w-100" style="background: transparent">
                                    ...
                                    <div class="col-md-4 mb-10 mb-md-0">
                                        ...
                                        <div class="d-flex align-items-center mb-13">
                                            ...
                                            <div class="d-flex flex-column mb-1">
                                                <a href="account/overview.html" class="title-custom fs-2">Max Smith</a>
                                        ...
                                        <div class="card card-flush bg-white border-0 mw-475px pt-3 pb-1">
                                            ...
                                            <div class="card-body pt-3">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    <!--begin::Link-->
                                                    <a href="pages/user-profile/overview.html" class="text-primary fw-bolder fs-6 opacity-75-hover">View All</a>
                                                    <!--end::Link-->
                                                    <!--begin::State-->
                                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                                        <label class="form-check-label text-gray-900 fw-bolder fs-6 me-3" for="flexSwitchDefault">Private</label>
